...
\Cref{tab:tab_Quad_compare_hover}
\begin{figure}[!h]
...
\begin{table}[!h]
\begin{center}
 \caption{Comparing the force capabilities of the designs.}\vspace{1ex}
...
\begin{table}[!h]
\begin{center}
 \caption{Comparing the torque capabilities of the designs .}\vspace{1ex}
...
\begin{table}[!h]
\begin{center}
 \caption{Comparing the hover efficiency of the designs.}\vspace{1ex}
